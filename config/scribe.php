...
return [
    ...
    'auth' => [
        ...
        'extra_info' => 'Use the <b>POST /login</b> endpoint to obtain your authentication token. Include the token in the Authorization header as <b>Bearer {token}</b> for all protected endpoints.',
    ],
    ...
    // Empty array to prevent database connection attempts during documentation generation
